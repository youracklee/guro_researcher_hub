...
export default function Sidebar() {
    ...
    return (
        <aside className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen sticky top-0 shrink-0 z-20 shadow-sm">
            <div className="h-auto pt-6 pb-2 flex flex-col items-center px-6 border-b border-gray-100 bg-white">
                <div className="w-full h-auto mb-1 relative flex items-center justify-center">
                    <img
